...
public interface ChatRepository extends JpaRepository<Chat, Long> {
  ...
  @Query(value = "SELECT c.*, (SELECT TOP 1 body FROM t_wsp_message m WHERE c.id = m.chat_id ORDER BY m.time DESC) as last_message FROM t_wsp_chat c", nativeQuery = true)
